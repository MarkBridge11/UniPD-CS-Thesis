...
Hibernate è un framework di mapping\textsubscript{g} oggetto-relazionale (ORM\textsubscript{g}). L'obiettivo principale di Hibernate è semplificare la gestione e l'accesso ai dati in un database relazionale utilizzando oggetti Java anziché scrivere query SQL manualmente.
\\
